...
public class _01_IntroToQueue {
    public static void main(String[] args) {
    	...
    	int remove = rnd.nextInt(5)+1;
    	System.out.println("Removing " + remove + " numbers from the Queue");
        ...
        System.out.println("Stack contains " + dubs.size() + " items.");
        while (!que.isEmpty()) {
			System.out.println(que.pop());
		}
        System.out.println("Queue contains " + que.size() + " items.");
    }
}
